...
<div class="container mt-5">
    ...
    <form action="update-coursePost" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="credit" name="credit" value="<%= course.getCredit() %>" required>
        </div>
        <div class="mb-3">
            <label for="address" class="form-label">Type</label>
            <input type="text" class="form-control" id="type" name="type" value="<%= course.getCtype() %>" required>
        </div>
